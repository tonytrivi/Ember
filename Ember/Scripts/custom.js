// inview code for top_center section in top_area

jQuery('#top_center').bind('inview', function (event, visible) {
  if (visible == true) {
    jQuery('#top_center').addClass("animated fadeIn");
  } else {
    // element has gone out of viewport
    jQuery('#top_center').removeClass("animated fadeIn");
